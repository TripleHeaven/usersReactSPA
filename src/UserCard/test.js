...
class StringSpace {
  ...
  constructor() {
      // ===
      this._ru = ['Р°', 'Р±РµР·', 'Р±РµР·Рѕ', 'РІ', 'РІРѕ', 'РІРЅРµ', 'РґР°', 'РґР»СЏ', 'РґРѕ', 'РµРµ', 'РµС‰Рµ', 'Рё', 'РёР»Рё', 'РёР·', 'РёР·Рѕ', 'РёР»Рё', 'РёС…', 'Р·Р°', 'Рє', 'РєР°Рє', 'РєРѕ', 'РјРµР¶', 'РЅР°', 'РЅР°Рґ', 'РЅРµ', 'Р±С‹Р»', 'РЅРё', 'РЅРѕ', 'Рѕ', 'РѕР±', 'РѕР±Рѕ', 'РѕС‚', 'РѕС‚Рѕ', 'РїРѕ', 'РїРѕРґ', 'РїСЂРё', 'РїСЂРѕ', 'СЃ', 'СЃРѕ', 'С‚Рѕ', 'С‚Р°Рј', 'Сѓ', 'СѓР¶', 'С‡С‚Рѕ', 'СЏ', 'рџЏ†', 'рџ’¬', 'рџ“±', 'рџ¤і', 'вќ¤пёЏ', 'вњЊпёЏ', 'рџ™€'];
      // ===
